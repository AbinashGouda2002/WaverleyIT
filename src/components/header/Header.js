                                ...
                                <div className="main_menu_inner collapse navbar-collapse justify-content-lg-center" id="main_menu_dropdown">
                                    <ul className="main_menu_list unordered_list justify-content-center">
                                        <li className="dropdown">
                                            ...
                                            <div className="dropdown-menu mega_menu_wrapper p-0" aria-labelledby="services_submenu" style={{ minWidth: '600px' }}>
                                                <div className="container">
                                                    <div className="row">
                                                        <div className="col-lg-4 bg-primary text-white p-4 rounded-start">
                                                            <h4>Our Services</h4>
                                                            <p>Explore our range of software solutions designed to empower your business.</p>
                                                        </div>
                                                        <div className="col-lg-8 p-4">
                                                            <div className="d-flex align-items-start mb-3">
                                                                <img src={icon7} alt="Web Development Icon" style={{ width: '40px', height: '40px', marginRight: '15px' }} />
                                                                <div>
                                                                    <h6 className="mb-1">Web Development</h6>
                                                                    <p className="mb-0 text-muted" style={{ fontSize: '0.9rem' }}>Custom web applications tailored to your needs.</p>
                                                                </div>
                                                            </div>
                                                            <div className="d-flex align-items-start mb-3">
                                                                <img src={icon1} alt="Cloud Solutions Icon" style={{ width: '40px', height: '40px', marginRight: '15px' }} />
                                                                <div>
                                                                    <h6 className="mb-1">Cloud Solutions</h6>
                                                                    <p className="mb-0 text-muted" style={{ fontSize: '0.9rem' }}>Scalable and secure cloud infrastructure.</p>
                                                                </div>
                                                            </div>
                                                            <div className="d-flex align-items-start">
                                                                <img src={icon2} alt="Cybersecurity Icon" style={{ width: '40px', height: '40px', marginRight: '15px' }} />
                                                                <div>
                                                                    <h6 className="mb-1">Cybersecurity</h6>
                                                                    <p className="mb-0 text-muted" style={{ fontSize: '0.9rem' }}>Protect your digital assets with our security solutions.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
